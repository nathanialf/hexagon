...
{	
	...
	public void set()
	{
		...
		menubuttons.add(new AudioButton());
		
		menubuttons.add(new GraphicsButton());
		
		menubuttons.add(new ApplyButton());
		menubuttons.add(new AutosaveButton());
		menubuttons.add(new ControlsButton());
